...
switch ($_GET['case']) {
    default:
        ...
        do {
            ...
            Кто удалил: <img src="images/flags/<?= $moder['side'] ?>.png" alt="Флаг"/><a
                    href="view.php?smotr=<?= $moder['id'] ?>"> <?= $moder['user'] ?></a>  <? //=$del['date']?><br>
            Кто писал: <img src="images/flags/<?= $usr['side'] ?>.png" alt="Флаг"/><a
                    href="view.php?smotr=<?= $usr['id'] ?>"> <?= $usr['user'] ?></a><br>
            Сообщение : <?= _Smile($del['text']) ?><br> <?= $del['date'] ?> в <?= $del['time'] ?><br>
            <hr><?php
